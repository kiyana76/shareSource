...
$db_query_konkor = mysqli_query($connect,"select * from `source_entrance_exam` where `Source_id`='$source_id'");
$Out_Put = array();
...
while ($row = mysqli_fetch_array($db_query_konkor)){
    $Item = array();
    $Item['year'] = $row['year'];
    $Out_Put_konkor [] = $Item;
}
...
<head>
    <meta charset="UTF-8">
    <title>سوالات کنکور</title><!--bayad name soal konkor motde nazar bashe-->
    <link rel="stylesheet" href="soalat%20konkor.css">
...
<div class="content" id="content">
    <img class="img_of_soal_konkor" src="<?php echo "../upload/".$Out_Put[0]['download_img'] ?>">
    <div class="information_soal_konkor" id="informaion_soal_konkor">
        <p>سوالات کنکور: <?php echo $Out_Put[0]['Course_name'] ?></p>
        <p>سال:<?php echo $Out_Put_konkor[0]['year'] ?></p>
