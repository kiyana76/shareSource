...
<head>
    <meta charset="UTF-8">
    <title>تایید کاربرهای تایید کننده</title>
    ...
    <table>
        ...
        while ($i < count($Out_Put)) {
            ...
            <tr>
                ...
                <td>
                    <form action="submit_secondery_user.php" method="post" id="checkbox_accept">
                        <input type="checkbox" name="accept">
                        <input type="hidden" name="First_name" value=<?php echo $Out_Put[$i]['First_name']?>>
                        <input type="hidden" name="Last_name" value=<?php echo $Out_Put[$i]['Last_name']?>>
                        <input type="hidden" name="Filed_id" value=<?php echo $Out_Put[$i]['Filed_id']?>>
                        <input type="hidden" name="Group_id" value=<?php echo $Out_Put[$i]['Group_id']?>>
                        <input type="hidden" name="email" value=<?php echo $Out_Put[$i]['Email']?>>
                        <input type="hidden" name="pass" value=<?php echo $Out_Put[$i]['pass']?>>
                </td>
                <td>
