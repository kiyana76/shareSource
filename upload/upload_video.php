...
<head>
    <meta charset="UTF-8">
    <title>آپلود ویدیو آموزشی</title>
...
<div class="content">
    <form action="process_video" method="post" id="upload" class="form_upload" onsubmit="return checkNotEmpty(this)" enctype="multipart/form-data">
        <ul class="ul_upload">
            <li class="li_upload">
                نام ویدیو:<input type="text" name="source_name" placeholder="نام ویدیو" class="input_upload" id="name">
            </li>
            <li class="li_upload">
                نام مدرس: <input type="text" name="Master_name" placeholder="نام مدرس" class="input_upload" id="master">
            </li>
            <li class="li_upload">
                مدت زمان: <input type="number" name="Course_Length" placeholder="مدت زمان" class="input_upload" id="quarter">
            </li>
            <li class="li_upload">
                آپلود فایل :<input type="file" name="file" class="input_upload" id="file" accept="video/*">
            </li>
            <li class="li_upload">
...
<script>
    ...
    function checkNotEmpty(form) {
        ...
        // If master not entered
            ...
            alert("لطفا نام مدرس را وارد کنید!");
            return false;
        }
        // If quarter not entered
        else if (quarter == '') {
            alert("لطفا مدت ویدیو را وارد کنید!");
            return false;
        }
        // If file not entered
        else if (upload_file == '') {
