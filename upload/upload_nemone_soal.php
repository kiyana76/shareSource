...
<div class="content">
    <form action="nemone_soal_process" method="post" id="upload" class="form_upload" onsubmit="return checkNotEmpty(this)" enctype="multipart/form-data">
        <ul class="ul_upload">
            <li class="li_upload">
                نام نمونه سوال:<input type="text" name="source_name" placeholder="نام نمونه سوال" class="input_upload" id="name">
            </li>
            <li class="li_upload">
                نام استاد: <input type="text" name="Master_name" placeholder="نام استاد" class="input_upload" id="master">
            </li>
            <li class="li_upload">
                ترم: <input type="number" name="term" placeholder="ترم" min="1" max="2" class="input_upload" id="quarter">
            </li>
            <li class="li_upload">
                سال:<input type="number" name="year"  placeholder="سال" min="1387" max="1404" class="input_upload" id="year">
            </li>
            <li class="li_upload">
                آپلود فایل :<input type="file" name="file" class="input_upload" id="file" accept=".rar,application/zip,application/pdf"> <p style="font-size: small">*فقط مجاز به آپلود PDF , ZIP , RAR هستید.</p>
            </li>
            <li class="li_upload">
                آپلود عکس :<input type="file" name="image" class="input_upload" id="image" accept="image/jpg,image/png,image/gif,image/jpeg">
            </li>
            <li class="li_upload">
...
<script>
    ...
    function checkNotEmpty(form) {
        ...
        // If master not entered
        else if (master == '') {
            alert("لطفا نام استاد را وارد کنید!");
            return false;
        }
        // If quarter not entered
        else if (quarter == '') {
            alert("لطفا ترم را وارد کنید!");
            return false;
        }
        // If year not entered
        else if (year == ''){
