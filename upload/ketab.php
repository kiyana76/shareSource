...
<div class="content">
    <form action="process_ketab.php" method="post" id="upload" class="form_upload" onsubmit="return checkNotEmpty(this)" enctype="multipart/form-data">
        <ul class="ul_upload">
            <li class="li_upload">
                نام کتاب:<input type="text" name="source_name" placeholder="نام کتاب" class="input_upload" id="name">
            </li>
            <li class="li_upload">
                نام نویسنده: <input type="text" name="Athor" placeholder="نام نویسنده" class="input_upload" id="master">
            </li>
            <li class="li_upload">
                ویرایش: <input type="number" name="Edit" placeholder="ویرایش"  class="input_upload" id="quarter">
            </li>
            <li class="li_upload">
                نام انتشارات:<input type="text" name="Publishers" placeholder="نام انتشارات"  class="input_upload" id="year">
            </li>
            <li class="li_upload">
...
<script>
    ...
    function checkNotEmpty(form) {
        ...
        // If name not entered
        if (name == ''){
            alert ("لطفا نام کتاب را وارد کنید");
            return false;
        }

        // If master not entered
        else if (master == '') {
            alert("لطفا نام نویسنده را وارد کنید!");
            return false;
        }
        // If quarter not entered
        else if (quarter == '') {
            alert("لطفا ویرایش را وارد کنید!");
            return false;
        }
        // If year not entered
        else if (year == ''){
            alert ("لطفا نام انتشارات را وارد کنید!");
            return false;
        }
        // If file not entered
        else if (upload_file == '') {
        ...
        // If image not entered
            ...
            alert("لطفا یک عکس برای کتاب آپلود کنید!");
            return false;
        }
