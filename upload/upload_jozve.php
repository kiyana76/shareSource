...
<div class="content">
   <form action="process_jozve.php" method="post" id="upload" class="form_upload" onsubmit="return checkNotEmpty(this)" enctype="multipart/form-data">
       <ul class="ul_upload">
            <li class="li_upload">
                نام جزوه:<input type="text" name="source_name" placeholder="نام جزوه" class="input_upload" id="name">
            </li>
            <li class="li_upload">
